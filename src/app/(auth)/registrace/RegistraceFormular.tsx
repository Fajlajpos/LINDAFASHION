...
export function RegistraceFormular({ captchaSiteKey }: { captchaSiteKey: string | null }) {
  ...
  /* Token z Turnstile platí jednou. Po neúspěšném pokusu se widget musí
     přegenerovat, jinak by druhé odeslání poslalo spotřebovaný token. */
